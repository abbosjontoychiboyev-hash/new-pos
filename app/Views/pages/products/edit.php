...
<head>
    ...
    <title>Mahsulotni tahrirlash - POS System</title>
                            ...
                            <select class="form-select" id="subkategoriya_id" name="subkategoriya_id">
                                ...
                                <?php if (isset($subcategories) && !empty($subcategories)): ?>
                                    <?php foreach ($subcategories as $sub): ?>
                                        <?php 
                                        $selected = '';
                                        if (isset($_SESSION['old']['subkategoriya_id']) && $_SESSION['old']['subkategoriya_id'] == $sub['id']) {
                                            $selected = 'selected';
                                        } elseif (!isset($_SESSION['old']['subkategoriya_id']) && ($product['subkategoriya_id'] ?? '') == $sub['id']) {
                                            $selected = 'selected';
                                        }
                                        ?>
                                        <option value="<?= $sub['id'] ?>" <?= $selected ?>>
                                            <?= htmlspecialchars($sub['nomi']) ?>
                                        </option>
                                    <?php endforeach; ?>
                                <?php endif; ?>
                            </select>
