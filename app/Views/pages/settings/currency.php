...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const separatorSelect = document.getElementById('thousandSeparator');
        
        if (symbolInput) symbolInput.addEventListener('input', updatePreview);
        if (positionSelect) positionSelect.addEventListener('change', updatePreview);
        if (decimalSelect) decimalSelect.addEventListener('change', updatePreview);
        if (separatorSelect) separatorSelect.addEventListener('change', updatePreview);
